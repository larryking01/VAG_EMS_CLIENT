                                ...
                                <Col className='add-employee-form-input-row'>
                                    ...
                                    <InputGroup>
                                        <Form.Control type='email'  
                                            aria-label='Secondary E-mail' onChange={ UpdateSecondaryEmail } value={ secondaryEmail }/>
                                        <InputGroup.Text><MdEmail /></InputGroup.Text>
                                    </InputGroup>
                                </Col>
                            </Row>
                                ...
                                <Col className='add-employee-form-input-row'>
                                    ...
                                    <InputGroup>
                                        <Form.Control type='file'  
                                            aria-label='Employee Photo' onChange={ UpdateEmployeePhoto } value={ employeePhoto } />
                                        <InputGroup.Text><IoPerson /></InputGroup.Text>
                                    </InputGroup>
                                </Col>
                            </Row>
