...
const SuccessDialog: React.FC<Dialog_Content_Text> = ( props ) => {

    return (
        <div>
            <Dialog open={ props.open } onClose={ props.handleClose }>
                <DialogTitle id='dialog-title' className='bg-green-600 text-white'>
                    <div className='flex'>
                        <h5 className='mr-4 text-xl '>Success</h5>
                        <LuCheckCircle size={ 30 } className='mt-0' />
                    </div>
                </DialogTitle>
